...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Hari Singh Joshi', url: 'https://portfolio-hari-singh.vercel.app/' }],
  openGraph: {
    ...
    url: 'https://portfolio-hari-singh.vercel.app/',
  ...
  metadataBase: new URL('https://portfolio-hari-singh.vercel.app/'),
};
